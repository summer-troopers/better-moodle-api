...
module.exports = {
  ...
  async up(queryInterface, Sequelize) {
    ...
    return LabReport.bulkCreate(await generate50LabReports(Student, CourseInstance, file.id), {});
  },
...
async function generate50LabReports(Student, CourseInstance, fileId) {
